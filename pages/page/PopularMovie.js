...
const PopularMovie = ({ movies }) => {
  ...
  return (
    <div className="bg-gray-700 container max-w-7xl mx-auto py-10 px-4 overflow-hidden">
      ...
      <div className="relative">
        ...
        />
        {/* <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5"></div> */}
        <div
